...
func init() {
	store.Register(types.SkyfireClusterRoleBindingV1, NewOpsSightClusterRoleBinding)
}
...
func (o *OpsSightClusterRoleBinding) GetClusterRoleBinding() (*components.ClusterRoleBinding, error) {
	...
	clusterRoleBinding.AddLabels(map[string]string{"component": "skyfire", "app": "opssight", "name": o.opsSight.Name})
