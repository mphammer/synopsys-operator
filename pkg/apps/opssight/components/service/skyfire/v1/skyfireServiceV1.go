...
func init() {
	store.Register(types.SkyfireServiceV1, NewOpsSightService)
}
...
func (o OpsSightService) GetService() (*components.Service, error) {
	...
	service.AddPort(horizonapi.ServicePortConfig{
		Port:       int32(o.opsSight.Spec.Skyfire.Port),
		TargetPort: fmt.Sprintf("%d", o.opsSight.Spec.Skyfire.Port),
		Protocol:   horizonapi.ProtocolTCP,
		Name:       "main-skyfire",
	})
	service.AddPort(horizonapi.ServicePortConfig{
		Port:       int32(o.opsSight.Spec.Skyfire.PrometheusPort),
		TargetPort: fmt.Sprintf("%d", o.opsSight.Spec.Skyfire.PrometheusPort),
		Protocol:   horizonapi.ProtocolTCP,
		Name:       "skyfire-prometheus",
	})

	service.AddLabels(map[string]string{"component": o.opsSight.Spec.Skyfire.Name, "app": "opssight", "name": o.opsSight.Name})
	service.AddSelectors(map[string]string{"component": o.opsSight.Spec.Skyfire.Name, "app": "opssight", "name": o.opsSight.Name})
