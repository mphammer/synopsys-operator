...
func init() {
	store.Register(types.OpsSightImageGetterServiceV1, NewOpsSightService)
}
...
func (o OpsSightService) GetService() (*components.Service, error) {
	service := components.NewService(horizonapi.ServiceConfig{
		Name:      utils.GetResourceName(o.opsSight.Name, util.OpsSightName, o.opsSight.Spec.ScannerPod.ImageFacade.Name),
		Namespace: o.opsSight.Spec.Namespace,
		Type:      horizonapi.ServiceTypeServiceIP,
	})

	service.AddLabels(map[string]string{"component": o.opsSight.Spec.ScannerPod.Name, "app": "opssight", "name": o.opsSight.Name})
	service.AddSelectors(map[string]string{"component": o.opsSight.Spec.ScannerPod.Name, "app": "opssight", "name": o.opsSight.Name})

	service.AddPort(horizonapi.ServicePortConfig{
		Port:       int32(o.opsSight.Spec.ScannerPod.ImageFacade.Port),
		TargetPort: fmt.Sprintf("%d", o.opsSight.Spec.ScannerPod.ImageFacade.Port),
		Protocol:   horizonapi.ProtocolTCP,
		Name:       fmt.Sprintf("port-%s", o.opsSight.Spec.ScannerPod.ImageFacade.Name),
	})
