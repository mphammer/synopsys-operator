...
func init() {
	store.Register(types.OpsSightScannerServiceV1, NewOpsSightService)
}
...
func (o OpsSightService) GetService() (*components.Service, error) {
	service := components.NewService(horizonapi.ServiceConfig{
		Name:      utils.GetResourceName(o.opsSight.Name, util.OpsSightName, o.opsSight.Spec.ScannerPod.Scanner.Name),
	...
	service.AddPort(horizonapi.ServicePortConfig{
		Port:       int32(o.opsSight.Spec.ScannerPod.Scanner.Port),
		TargetPort: fmt.Sprintf("%d", o.opsSight.Spec.ScannerPod.Scanner.Port),
		Protocol:   horizonapi.ProtocolTCP,
		Name:       fmt.Sprintf("port-%s", o.opsSight.Spec.ScannerPod.Scanner.Name),
	})
