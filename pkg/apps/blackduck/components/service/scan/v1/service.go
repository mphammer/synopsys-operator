...
func init() {
	store.Register(types.BlackDuckScanServiceV1, NewBdService)
}
...
func (b BdService) GetService() (*components.Service, error) {
	return util.CreateService(apputils.GetResourceName(b.blackDuck.Name, util.BlackDuckName, "scan"), apputils.GetLabel("scan", b.blackDuck.Name), b.blackDuck.Spec.Namespace, int32(8443), int32(8443), horizonapi.ServiceTypeServiceIP, apputils.GetVersionLabel("scan", b.blackDuck.Name, b.blackDuck.Spec.Version)), nil
}
