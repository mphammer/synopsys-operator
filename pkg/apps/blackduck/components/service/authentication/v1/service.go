...
func (b BdService) GetService() (*components.Service, error) {
	...
	return util.CreateService("authentication", apputils.GetLabel("authentication", b.blackDuck.Name), b.blackDuck.Spec.Namespace, int32(8443), int32(8443), horizonapi.ServiceTypeServiceIP, apputils.GetVersionLabel("authentication", b.blackDuck.Name, b.blackDuck.Spec.Version)), nil
}
