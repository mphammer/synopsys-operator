...
func init() {
	store.Register(types.BlackDuckWebserverServiceV1, NewBdService)
}
...
func (b BdService) GetService() (*components.Service, error) {
	return util.CreateService(apputils.GetResourceName(b.blackDuck.Name, util.BlackDuckName, "webserver"), apputils.GetLabel("webserver", b.blackDuck.Name), b.blackDuck.Spec.Namespace, int32(443), int32(8443), horizonapi.ServiceTypeServiceIP, apputils.GetVersionLabel("webserver", b.blackDuck.Name, b.blackDuck.Spec.Version)), nil
}
